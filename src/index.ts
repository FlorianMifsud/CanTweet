export function canTweet(tweet: string): boolean {
  const scale = 100,
    defaultWeight = 200,
...
function transformEntitiesToHash(entities: Array<any>): any {
...
function getCharacterWeight(ch: string, options: any): number {
...
function extractWithIndices(text: string, expression: RegExp): Array<any> {
